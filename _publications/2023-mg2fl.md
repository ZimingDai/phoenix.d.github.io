...
<img src="../images/publications/mggfl.png" alt="The framework of multi-granularity grouping-based FL" style="max-width: 80%; display: block; margin: 20px auto; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
